Some code I wrote to run the first-order opproximations of the Strong Disorder Renormalization Group algorithm on a 3D Ising Model lattice and analyze the domains and scaling behavior. 
